...
async def test_complete_expert_user_flow(fake_llm):
    ...
    # --- 1. Injection Phase ---
    entities = [
        {"name": "Project Rigour", "entity_type": "security", "description": "Deterministic safety layer"}
    ]
    relations = [
        {"subject": "Project Rigour", "object": "LogicHive", "predicate": "secures"}
    ]
    bank_files = [
        {"filename": "rigour_specs.md", "content": "# Rigour Specifications\nMust be deterministic."}
    ]
    ...
    print("System test complete: Verified bootstrap, injection, search, lifecycle, and snapshotting.")
