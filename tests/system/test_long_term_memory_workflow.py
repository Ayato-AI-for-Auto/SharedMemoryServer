...
from shared_memory.logic import save_memory_core, get_value_report_core, read_memory_core
...
async def test_cross_session_synthesis_workflow():
    ...
    assert any(o["entity"] == "SharedEntity" and "Updated observation" in o["content"] for o in observations)
