...
from shared_memory.server import save_memory, read_memory, synthesize_entity
...
async def run_debug():
    ...
    context_snippets = [f"Entity {e['name']}: {e['description']}" for e in search_res["graph"]["entities"]]
